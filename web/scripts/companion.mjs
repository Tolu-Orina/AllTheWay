...
const widths = [
  { name: "phone", w: 390, h: 844, docked: false },
  { name: "tablet", w: 900, h: 1000, docked: false },
  { name: "laptop-devtools", w: 1100, h: 800, docked: false },
  { name: "desktop", w: 1440, h: 900, docked: true },
];
...
for (const v of widths) {
  ...
  if (v.docked) {
    ok(await aside.isVisible(), "docked column is visible");
    ok(!(await fab.isVisible()), "FAB is hidden where the column is docked");
  } else {
